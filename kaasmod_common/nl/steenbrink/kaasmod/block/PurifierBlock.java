...
public class PurifierBlock extends BlockContainer {
    ...
    {
        this.blockIcon = Texture.getIconFromTextureName(iconRegister, "PurifierSides");
        this.iconFront = Texture.getIconFromTextureName(iconRegister, "PurifierDisabled");
        this.iconActivated = Texture.getIconFromTextureName(iconRegister, "PurifierActivated");
    }
    ...
    public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int x, int y, int z, int side) 
    {
        ...
        TilePurifier tile = (TilePurifier) par1iBlockAccess.getBlockTileEntity(x, y, z);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, int par6, float par7, float par8, float par9) {
        if (world.isRemote) {
            ...
            if (tilePurifier != null) {
                entityPlayer.openGui(kaasmod.instanceK, Reference.GUI_PURIFIER_ID, world, x, y, z);
            }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        TilePurifier var7 = (TilePurifier)par1World.getBlockTileEntity(par2, par3, par4);
