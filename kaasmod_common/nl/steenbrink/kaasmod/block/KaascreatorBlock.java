...
public class KaascreatorBlock extends BlockContainer {
    
    public KaascreatorBlock(int id) {
    ...
    {
        this.blockIcon = Texture.getIconFromTextureName(iconRegister, "KaascreatorSides");
        this.iconFront = Texture.getIconFromTextureName(iconRegister, "KaascreatorDisabled");
        this.iconActivated = Texture.getIconFromTextureName(iconRegister, "KaascreatorActivated");
    }
    ...
    public Icon getBlockTexture(IBlockAccess par1iBlockAccess, int x, int y, int z, int side) 
    {
        ...
        TileKaascreator tile = (TileKaascreator) par1iBlockAccess.getBlockTileEntity(x, y, z);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, int par6, float par7, float par8, float par9) {
        if (world.isRemote) {
            ...
            if (tileKaascreator != null) {
                entityPlayer.openGui(kaasmod.instanceK, Reference.GUI_KAASCREATOR_ID, world, x, y, z);
            }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        TileKaascreator var7 = (TileKaascreator)par1World.getBlockTileEntity(par2, par3, par4);
